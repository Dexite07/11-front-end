...
<a href="home">
 <p className="font-mono text-2xl ml-50">Chartreused |</p>
      ...
      <div className="w-150 h-50 ">
        <h1 className="text-8xl text-[#141414] font-mono font-extrabold">Contact Information.</h1>
        <div className="w-80 h-full">
          <p className="text-[#141414] font-mono mt-5">Contact us via chartreused@gmail.com !</p>
        </div>
        <p className="text-black font-mono font-bold text-xl mt-60 ml-129 absolute">Sonor - Studio Album</p>
        <p className="text-black font-mono font-regular text-lg mt-70 ml-170 absolute">By Enji</p>
        
      </div>
      <div className="w-140 h-140 bg-black ml-50 mt-40 shadow-xl/40">
        <img src="https://f4.bcbits.com/img/a2367283324_16.jpg"></img>
      </div>
